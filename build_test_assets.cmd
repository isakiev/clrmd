...
set csc="C:\Development\clrmd\Tools\microsoft.net.compilers\2.0.0-rc\tools\csc.exe"
set cdb32="C:\Program Files (x86)\Windows Kits\10\Debuggers\x86\cdb.exe"
set cdb64="C:\Program Files (x86)\Windows Kits\10\Debuggers\x64\cdb.exe"
...
set SourcePath=%~dp0\Src\Microsoft.Diagnostics.Runtime.Tests\Data
...
%csc% /debug /target:library /out:%Bin32%\SharedLibrary.dll /pdb:%Bin32%\SharedLibrary.pdb %SourcePath%\SharedLibrary.cs
%csc% /debug /target:library /out:%Bin64%\SharedLibrary.dll /pdb:%Bin64%\SharedLibrary.pdb %SourcePath%\SharedLibrary.cs
