...
namespace Microsoft.Diagnostics.Runtime.ICorDebug
{
  ...
  internal interface IMetadataImport2 : IMetadataImport
  {
    ...
    //         ULONG       *pcbSig) PURE;          // [OUT] return size of signature.  
    [PreserveSig]
    new int GetTypeSpecFromToken(uint token, [Out] out IntPtr sig, [Out] out int sigLen);
    ...
    */
    ...
    void GetMethodSpecProps(
      [ComAliasName("mdMethodSpec")] int mi,
  ...
  [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)] // IID_IMetadataAssemblyImport from cor.h
