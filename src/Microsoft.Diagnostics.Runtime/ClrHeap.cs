...
namespace Microsoft.Diagnostics.Runtime
{
  ...
  public abstract class ClrSegment
  {
    ...
    {
      if (Gen0Start <= obj && obj < Gen0Start + Gen0Length) return 0;

      if (Gen1Start <= obj && obj < Gen1Start + Gen1Length) return 1;

      if (Gen2Start <= obj && obj < Gen2Start + Gen2Length) return 2;
