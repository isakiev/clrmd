...
namespace Microsoft.Diagnostics.Runtime
{
 ...
 /*[in] ULONG32 index,
     ...
     */
    void GetILOffsetsByAddress(
      ulong address,
      uint offsetsLen,
      out uint offsetsNeeded,
      [Out][MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)]
      uint[] ilOffsets);

    void GetAddressRangesByILOffset(
      uint ilOffset,
      uint rangesLen,
      out uint rangesNeeded,
      [Out][MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)]
      uint[] addressRanges);
 ...
 /*[in] ULONG32 reqCode,
  ...
  internal interface IXCLRDataModule
  {
    ...
    void Request_do_not_use(
 /*[in] ULONG32 reqCode, [in] ULONG32 inBufferSize, [in, size_is(inBufferSize)] BYTE* inBuffer, [in] ULONG32 outBufferSize, [out, size_is(outBufferSize)] BYTE* outBuffer*/);
