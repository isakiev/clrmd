...
namespace Microsoft.Diagnostics.Runtime.Utilities
{
  ...
  public sealed unsafe class PEHeader
  {
    ...
    private ImageDataDirectory* NTDirectories
    {
      get
      {
        if (IsPE64)
          return (ImageDataDirectory*)((byte*)_ntHeader + sizeof(IMAGE_NT_HEADERS) + sizeof(IMAGE_OPTIONAL_HEADER64));

        return (ImageDataDirectory*)((byte*)_ntHeader + sizeof(IMAGE_NT_HEADERS) + sizeof(IMAGE_OPTIONAL_HEADER32));
      }
    }
