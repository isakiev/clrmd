    ...
    protected internal static class DumpNative
    {
      ...
      public class MINIDUMP_EXCEPTION_STREAM
      {
        ...
        public MINIDUMP_EXCEPTION_STREAM(DumpPointer dump)
        {
          ...
          for (var i = 0; i < EXCEPTION_MAXIMUM_PARAMETERS; i++) ExceptionRecord.ExceptionInformation[i] = dump.PtrToStructureAdjustOffset<ulong>(ref offset);
      ...
      public class LoadedFileMemoryLookups
      {
        ...
        private unsafe void InternalGetBytes(IntPtr src, IntPtr dest, uint bytesRequested, ref uint bytesWritten)
        {
          ...
          for (bytesWritten = 0; bytesWritten < bytesRequested; bytesWritten++) pDest[bytesWritten] = pSrc[bytesWritten];
        }
      }
      #endregion // Memory
    } // End native methods
...
#pragma warning disable 0420
  ...
  internal class DumpModule
  {
    ...
    private readonly DumpReader.DumpNative.MINIDUMP_MODULE _raw;
